...
const AddFoodModal = ({ modal, openModal, closeModal }) => {
                                            ...
                                            <div className="mt-2">
                                                <div className="form bg-white w-full p-6 lg:px-16 xl:px-12  border  justify-center">
                                                    <h2 className="about-span text-center text-xl">
                                                        Add New Item Food name and price
                                                    </h2>
                                                    <form onSubmit={handleSubmit(onSubmit)}>
                                                        ...
                                                        <input
                                                            ...
                                                            className="flex items-center justify-center h-12 px-6 w-full bg-yellow-700 mt-8 rounded font-semibold text-sm text-blue-100 cursor-pointer"
                                                            type="submit"
                                                            value="Add Food"
                                                        />
                                                    </form>
